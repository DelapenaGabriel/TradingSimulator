    ...
    <div class="create-container">
      <form class="profile-form" @submit.prevent="createProfile(profile)">
        <div class="left-side">
          ...
          <input type="text" id="name" maxlength="50" v-model="profile.name" required />

          <label for="number">Phone Number<span>*</span></label>
          <input type="text" id="number" maxlength="20" v-model="profile.phoneNumber" required  />

          <label for="address">Street Address<span>*</span></label>
          <input type="text" id="address" maxlength="50" v-model="profile.address" required />

          <label for="city">City<span>*</span></label>
          <input type="text" id="city" maxlength="20" v-model="profile.city" required />

          <label for="state">State<span>*</span></label>
            <select class="form-select" aria-label="Default select example" v-model="profile.state" required >
          ...
          <input type="text" id="zip" maxlength="5" v-model="profile.zipCode" required  />
...
@media screen and (max-width: 1044px) {
  .headline-background, .profile-form{
    width: 90vw;
    height: 100%;
  }
  .left-side, .right-side{
  ...
  .profile-form, .headline-background{
   width: 95vw;
  }
