...
public class JdbcUserDaoTests extends BaseDaoTests {
    ...
    public void findAll_returns_all_users() {
        ...
        Assert.assertEquals("getUsers returned a list with the incorrect number of users", 4, users.size());
        ...
        Assert.assertEquals("getUsers returned a list in incorrect order", USER_4, users.get(3));
    }
